...
public final class FactionPanel implements InventoryPanel {
    ...
    public boolean mouseClicked(double mouseX, double mouseY, int button) {
        ...
        // is 0 left, 1 right, 2 middle whatever the Minecraft line numbers them as. Compare a RAW
        // platform button against a literal and you have a latent version break — that is what
        // 26.3's GLFW-to-SDL swap did to five separate call sites — but this value is not raw, and
        // rewriting it to a constant would reintroduce exactly the bug the normalisation removed.
        if (button != 0) {
            return false;
        }
